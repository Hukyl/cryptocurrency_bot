...
# os.path.join is used to join the directories of the path
# e.g. os.path.join("..", "chromedriver.exe") will mean "..\chromedriver.exe" on Windows and "../chromedrvier.exe" on Linux or MacOS
